...
from airrobot_srvs.srv import TopologyPlanner
...
class GraphSearchNode(Node):
    def __init__(self, filename):
        ...
        self.srv = self.create_service(TopologyPlanner, 'topology_planner', self.topology_planner_callback)
    ...
    def topology_planner_callback(self, request, response):
        start = request.start
        ...
        response.path = str(returned_path)
